                                ...
                                <div className=" max-w-xl  flex flex-col gap-5 ">
                                    ...
                                    <div className="flex flex-col gap-5">
                                        <p className="body_small md:body_medium">
                                            В Волга Трак Центре представлен
                                            широкий ассортимент грузовиков,
                                            тягачей и самосвалов от ведущих
                        ...
                        <div className="flex max-lg:flex-col gap-5 xl:gap-10 ">
                            <div className=" w-full lg:w-2/3 lg:order-2 justify-center  flex flex-col">
                                <div className=" max-w-xl  flex flex-col gap-5 ">
                                    ...
                                    <div className="flex flex-col gap-5">
                                        <p className="body_small md:body_medium">
                                            Каждый грузовик в Волга Трак Центре
                                            проходит тщательную предпродажную
                                            подготовку и тестирование.
                                        </p>
                                        <p className="body_small md:body_medium">
                                ...
                                <div className=" max-w-xl  flex flex-col gap-5 ">
                                    ...
                                    <div className="flex flex-col gap-5">
                                        <p className="body_small md:body_medium">
                                            ...
                                            продажей. Волга Трак Центр
                                            предлагает комплексное
                                            послепродажное обслуживание: от
                                            регулярного технического
                                            обслуживания до капитального ремонта
                                            и модернизации.
                                        </p>
                                        <p className="body_small md:body_medium">
